...
class GroupWidget extends StatefulWidget {
  const GroupWidget({super.key, required this.group, required this.groupId});
  final Group group;
...
class _GroupWidgetState extends State<GroupWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    return InkWell(
      onTap: () {
        Navigator.push(
            context, MaterialPageRoute(builder: (context) => ChatPage(group: widget.group, groupId: widget?.groupId,)));
      },
      child: Expanded(
        flex: 10,
        child: Padding(
